...
public class TileEntityGatlingGunWitchburn extends TileEntityGatlingGunEmber {

	public TileEntityGatlingGunWitchburn() {
		gunStack = new ItemStack(EmbersCompat.witchburnGatlingGun);
	}
	...
	public void fireUpdate() {
		...
		EffectArea effect = new EffectArea(new EffectMulti(Lists.newArrayList(new EffectDamage(damage, DamageEmber.EMBER_DAMAGE_SOURCE_FACTORY, 0, 0.5), new EffectWitchburn(500))), 0.5, false);
